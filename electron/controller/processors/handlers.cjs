...
const procesarPaginaMensual = (
  ...
  const ajustarQuincenaAnterior =
    pag.mensual === true && esSegundaQuincena(nombreQuincenaActual);
  ...
  switch (moneda) {
    case "USD":
      return procesarUSDMensual(
        ...
        porcentaje,
        usd,
        ultimosValoresAnteriores
      );
    case "EURO":
      return procesarEUROMensual(
        pageData,
        dia,
        anterior,
        porcentaje,
